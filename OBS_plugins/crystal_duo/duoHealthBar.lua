...
frame_width        = 448
frame_height       = 35
frames_per_set     = 15 -- normal frames: 0–14
flash_frame_index  = 15 -- white flash frame (frame 15)
total_frames       = 16 -- 15 normal + 1 flash
flash_duration_ms  = 150

-- player state
players = {
    player1 = {
        source_name = "Player1CrystalBar",
        health = 14,
        max_health = 14,
...
function script_properties()
    ...
    obs.obs_properties_add_text(props, "player1_source", "Crystal P1 Source", obs.OBS_TEXT_DEFAULT)
    obs.obs_properties_add_text(props, "player2_source", "Crystal P2 Source", obs.OBS_TEXT_DEFAULT)
    return props
end
...
function script_load(settings)
    ...
    p1.increase_hotkey_id = obs.obs_hotkey_register_frontend("increaseHealthP1", "IncHealth - CrystalP1", increaseHealthP1)
    p1.decrease_hotkey_id = obs.obs_hotkey_register_frontend("decreaseHealthP1", "DecHealth - CrystalP1", decreaseHealthP1)

    p2.increase_hotkey_id = obs.obs_hotkey_register_frontend("increaseHealthP2", "IncHealth - CrystalP2", increaseHealthP2)
    p2.decrease_hotkey_id = obs.obs_hotkey_register_frontend("decreaseHealthP2", "DecHealth - CrystalP2", decreaseHealthP2)
